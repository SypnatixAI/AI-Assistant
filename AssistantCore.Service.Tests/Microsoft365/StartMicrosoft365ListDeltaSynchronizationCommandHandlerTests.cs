using AssistantCore.Service.Application.Commands.StartMicrosoft365ListDeltaSynchronization;
using AssistantCore.Service.Application.Models.Microsoft365;
using AssistantCore.Service.Application.Services.Microsoft365;

namespace AssistantCore.Service.Tests.Microsoft365;

public sealed class StartMicrosoft365ListDeltaSynchronizationCommandHandlerTests
{
    ...
    public async Task Given_ADeltaSynchronization_When_HandleAsync_Then_DelegatesToSynchronizationService(
        ...
        Microsoft365ListDeltaSynchronizationResult expectedResult,
        CancellationToken cancellationToken)
    {
        // Given
        var service = new RecordingService(expectedResult);
        var handler = new StartMicrosoft365ListDeltaSynchronizationCommandHandler(service);
        var command = new StartMicrosoft365ListDeltaSynchronizationCommand(sourceId, synchronizationId);
    ...
    private sealed class RecordingService(Microsoft365ListDeltaSynchronizationResult result)
